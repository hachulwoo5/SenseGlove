...
namespace SG
{
    ...
    public class SG_Grabable_Origin : SG_Interactable
    {
        ...
        public float correctionSpeedValue;
        public float correctionAngularValue;
            ...
            if (grabbedScript != null && grabbedScript.GrabScript != null)
            {
                ...
                if (handPhysics != null) //the hand has a RigidBody + physics colliders
                {
                    ...
                    //if (IsMovedByPhysics) // I have a rigidBody. return rigidbodies
                    {
                        ...
                        //}
                        //  Debug.Log("Returning fingers back to physicsCollider");
                        handPhysics.SetIgnoreCollision(this.GetPhysicsColliders(), false); //ignore collision until the colliders are no longer near the object - prevent tossing.
        ...
        {
            base.Start();
            correctionSpeedValue = 1.5f;
            correctionAngularValue = 1.2f;

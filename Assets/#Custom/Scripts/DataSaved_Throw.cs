...
public class DataSaved_Throw : MonoBehaviour
{
    public string namer;
    ...
    void Update ( )
    {
        ...
        {
            SaveDataToCSV ( namer , elapsedTime , ThrowCount );
        }
    }

    void SaveDataToCSV ( string name , float elapsedTime , float throwCount )
    {
        ...
        // CSV 형식의 문자열 포맷
        string csvLine = $"{name},{currentTime},{elapsedTime:F2},{ThrowCount:F2}\n";
